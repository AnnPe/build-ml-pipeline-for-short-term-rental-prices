...
def go(args):
    ...
    # YOUR CODE HERE
    signature = mlflow.models.infer_signature(X_train.iloc[:5], y_train.iloc[:5])
    mlflow.sklearn.save_model(sk_model = sk_pipe, path = "random_forest_dir", input_example = X_train.iloc[:5], signature = signature)
    ######################################
